...
public:
    ...
    static InvokeTimerPtr Create(EventLoop* evloop, Duration timeout, const Functor& f, bool periodic);
    static InvokeTimerPtr Create(EventLoop* evloop, Duration timeout, Functor&& f, bool periodic);
    ~InvokeTimer();
