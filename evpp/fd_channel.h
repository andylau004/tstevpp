...
public:
    FdChannel(EventLoop* loop, evpp_socket_t fd, bool r, bool w);
    ~FdChannel();
...
private:
    void HandleEvent(evpp_socket_t sockfd, short which);
    static void HandleEvent(evpp_socket_t sockfd, short which, void* v);
